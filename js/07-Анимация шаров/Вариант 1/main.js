input = document.querySelector('input#ballsnum');
...
// Количество шаров по умолчанию будет 25
var userInput = 25;

// Если что-то введено в поле Input, количество шаров изменяется
function start() {
  if (input.value) {
